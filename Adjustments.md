...
- Briarwitchery, a new type of magic. Briarwitchery focuses on animal and plant life, and requires its own version of mana that only regenerates in the wild (and is reduced to zero if you have ANY bionics at all), but has reduced function in civilized areas. (heavily WIP)
